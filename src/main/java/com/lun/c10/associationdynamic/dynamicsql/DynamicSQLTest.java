package com.lun.c10.associationdynamic.dynamicsql;
...
public class DynamicSQLTest {
	...
	public static void main(String[] args) throws Exception {
		...
		InputStream inputStream = Resources.getResourceAsStream("c10-mybatis-config4.xml");
...
//		params.put("password", "123456");
	...
	public void testUpdateEmployeeIfNecessary(SqlSession session){
		EmployeeMapper em = session.getMapper(EmployeeMapper.class);
		Employee employee = em.selectEmployeeWithId(1);
		// 设置需要修改的属性
